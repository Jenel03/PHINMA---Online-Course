...
public class ModuleFiveSub2 extends AppCompatActivity {
    String title;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_module_five_sub2);
        ...
        String htmlAsString = getString(R.string.ModuleFiveSub2);
