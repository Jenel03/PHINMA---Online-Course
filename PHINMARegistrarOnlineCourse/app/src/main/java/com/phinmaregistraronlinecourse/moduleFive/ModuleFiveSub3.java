...
public class ModuleFiveSub3 extends AppCompatActivity {
    String title;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_module_five_sub3);
        ...
        String htmlAsString = getString(R.string.ModuleFiveSub3);
