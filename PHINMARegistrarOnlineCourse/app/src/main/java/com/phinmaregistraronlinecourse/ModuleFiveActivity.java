...
import com.phinmaregistraronlinecourse.moduleFive.ModuleFiveSub2;
import com.phinmaregistraronlinecourse.moduleFive.ModuleFiveSub3;
...
public class ModuleFiveActivity extends AppCompatActivity {
    ...
    private static final String TAG = ModuleFiveActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if(number==1){
                    Intent intent=new Intent(getApplicationContext(),ModuleFiveSub1.class);
                    intent.putExtra("title",subModule.getTitle());
                    startActivity(intent);
                }
                else if(number==2){
                    Intent intent=new Intent(getApplicationContext(),ModuleFiveSub2.class);
                    intent.putExtra("title",subModule.getTitle());
                    startActivity(intent);
                }
                else if(number==3){
                    Intent intent=new Intent(getApplicationContext(),ModuleFiveSub3.class);
                    intent.putExtra("title",subModule.getTitle());
                    startActivity(intent);
                }
