...
import com.phinmaregistraronlinecourse.moduleThree.ModuleThreeSub2;
import com.phinmaregistraronlinecourse.moduleThree.ModuleThreeSub3;
import com.phinmaregistraronlinecourse.moduleThree.ModuleThreeSub4;
...
public class ModuleThreeActivity extends AppCompatActivity {
    ...
    private static final String TAG = ModuleThreeActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if(number==1){
                    Intent intent=new Intent(getApplicationContext(),ModuleThreeSub1.class);
                    intent.putExtra("title",subModule.getTitle());
                    startActivity(intent);
                }
                else if(number==2){
                    Intent intent=new Intent(getApplicationContext(),ModuleThreeSub2.class);
                    intent.putExtra("title",subModule.getTitle());
                    startActivity(intent);
                }
                else if(number==3){
                    Intent intent=new Intent(getApplicationContext(),ModuleThreeSub3.class);
                    intent.putExtra("title",subModule.getTitle());
                    startActivity(intent);
                }
                else if(number==4){
                    Intent intent=new Intent(getApplicationContext(),ModuleThreeSub4.class);
                    intent.putExtra("title",subModule.getTitle());
                    startActivity(intent);
                }
