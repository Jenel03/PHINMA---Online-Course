...
public class Constants {
    ...
    private static final String ROOT_URL = "http://192.168.1.10/Phinma/Android/v1/";
    ...
    public static final String IMAGE_URL = "http://192.168.1.10/RegistrarOnlineCourse/others/";
