...
public class Constants {
    ...
    private static final String ROOT_URL = "http://192.168.1.5/Phinma/Android/v1/";
    ...
    public static final String URL_AWARDS = ROOT_URL+"awards.php";

    public static final String IMAGE_URL = "http://192.168.1.5/RegistrarOnlineCourse/others/";
