...
public class ModuleTwoSub3 extends AppCompatActivity {
    String title;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_module_two_sub3);
        ...
        String htmlAsString = getString(R.string.ModuleTwoSub3);
        String htmlAsString2 = getString(R.string.ModuleTwoSub3_1);
        String htmlAsString3 = getString(R.string.ModuleTwoSub3_2);
