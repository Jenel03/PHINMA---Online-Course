...
public class ModuleTwoSub6 extends AppCompatActivity {
    String title;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_module_two_sub6);
        ...
        setTitle(title);
        String htmlAsString = getString(R.string.ModuleTwoSub6);
        String htmlAsString2 = getString(R.string.ModuleTwoSub6_1);
